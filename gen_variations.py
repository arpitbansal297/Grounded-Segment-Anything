...
if __name__ == "__main__":
    ...
    for i in range(len(masks)):
        ...
        mask.save(os.path.join(masked_directory, f"mask.png"))
        ...
        print(inpaint_image)
        inpaint_image.save(os.path.join(masked_directory, f"inpaint_image.jpg"))



        binary_mask = Image.open(os.path.join(masked_directory, f"mask.png")).convert('L')
        ...
        new_mask_image.save(os.path.join(masked_directory, f"new_mask.png"))
        ...
        print(inpaint_image)
        inpaint_image.save(os.path.join(masked_directory, f"inpaint_new_mask_image.jpg"))
