...
if __name__ == "__main__":
    ...
    for i in range(len(masks)):
        ...
        negative_prompt = "Bad quality, bad composition, disfigured, mutated body parts, cropped, incomplete" \
        ...
        for i in range(len(objects_list)):
            ...
            if object_to_replace_with == "":
                ...
                prompt = f"A high quality picture, detailed, 8k uhd. It must have complete {object_to_replace_with} " \
                         f"well with in the image."
                print(f"Prompt: {prompt}")
